...
JNI_METHOD(void, nativeSetParameter)
(JNIEnv* env, jobject obj, jlong native_app, jfloat aSp, jfloat bSp, jfloat aAn, jfloat bAn) {
  native(native_app)->SetParameter(aSp, bSp, aAn, bAn);
}

JNI_METHOD(void, nativeSwitchPlan)
